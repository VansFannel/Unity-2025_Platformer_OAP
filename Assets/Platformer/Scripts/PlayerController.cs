...
{
    [SerializeField]
    private float jumpForce = 400.0f;                          // Amount of force added when the player jumps.
    ...
    [SerializeField]
    private Collider2D crouchDisableCollider;                // A collider that will be disabled when crouching
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (grounded || airControl)
        {
            ...
            Vector3 targetVelocity = new Vector2(move * 10f, rigbody2D.linearVelocity.y);
            // And then smoothing it out and applying it to the character
            rigbody2D.linearVelocity = 
                Vector3.SmoothDamp(
                    rigbody2D.linearVelocity,
                    targetVelocity,
                    ref velocity,
